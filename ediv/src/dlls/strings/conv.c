...
void inicializa_lower()
{
	...
	set_c_lower  ("abcdefghijklmnopqrstuvwxyz","abcdefghijklmnopqrstuvwxyz");
	set_c_lower  ("ÁÉÍÓÚÑÇÀÈÌÒÙÄËÏÖÜİÂÊÎÔÛÆÃÅÕ","áéíóúñçàèìòùäëïöüıâêîôûæãåõ");
	set_c_lower("áéíóúñçàèìòùäëïöüıâêîôûæãåõ","áéíóúñçàèìòùäëïöüıâêîôûæãåõ");
...
void inicializa_upper()
{
	...
	set_c_upper  ("ABCDEFGHIJKLMNOPQRSTUVWXYZ","ABCDEFGHIJKLMNOPQRSTUVWXYZ");
	set_c_upper  ("áéíóúñçàèìòùäëïöüıâêîôûæãåõ","ÁÉÍÓÚÑÇÀÈÌÒÙÄËÏÖÜİÂÊÎÔÛÆÃÅÕ");
	set_c_upper("ÁÉÍÓÚÑÇÀÈÌÒÙÄËÏÖÜİÂÊÎÔÛÆÃÅÕ","ÁÉÍÓÚÑÇÀÈÌÒÙÄËÏÖÜİÂÊÎÔÛÆÃÅÕ");
